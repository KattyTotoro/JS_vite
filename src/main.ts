...
// Если диаметр равен или меньше стороны, тогда впишется
...
// DZ_Modul_1_Week_3  - В работе.   Выполнено: 1, 2, 3, 4, 5, 6,   ... 9
...
// PZ_Modul_1_Week_3 - Сделано: WHILE: выполнено полностью. DO WHILE: выполнено полностью. FOR 3, 4,
